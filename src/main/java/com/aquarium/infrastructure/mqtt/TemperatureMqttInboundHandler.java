...
public class TemperatureMqttInboundHandler {
    ...
    public MessageHandler temperatureMessageHandler() {
        return (Message<?> message) -> {
            try {
                ...
                recordTemperatureUseCase.recordTemperature(aquariumId, value);

            } catch (Exception e) {
                // TODO: fazer LOG depois
                System.out.println("Falha processando MQTT temperatura: " + e.getMessage());
            }
        };
    }
